...
context('i18n | CA', () => {
  ...
  it('Should have CA sentences in Head component', () => {
    cy.fixture('i18nCA').then((translations) => {
  ...
  it('Should have CA sentences in Header component', () => {
  ...
  it('Should have CA sentences in NavButtons component', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
  ...
  it('Should have CA sentences in CalcInput component header & subheader link', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
  ...
  it('Should have CA sentences in Form component input labels', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
  ...
  it('Should have CA sentences in Results component type low', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
  ...
  it('Should have CA sentences in Results component type intermediate with risk factors (1)', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
  ...
  it('Should have CA sentences in Results component type intermediate with risk factors (2)', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have CA sentences in Results component type intermediate with high LDL', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have CA sentences in Results component type intermediate with no risks', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have CA sentences in Results component type high', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have CA sentences in Info container', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nCA').then((translations) => {
