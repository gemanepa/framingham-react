...
context('i18n | SV', () => {
  ...
  it('Should have SV sentences in Head component', () => {
    cy.fixture('i18nSV').then((translations) => {
  ...
  it('Should have SV sentences in Header component', () => {
  ...
  it('Should have SV sentences in NavButtons component', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
  ...
  it('Should have SV sentences in CalcInput component header & subheader link', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
  ...
  it('Should have SV sentences in Form component input labels', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
  ...
  it('Should have SV sentences in Results component type low', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
  ...
  it('Should have SV sentences in Results component type intermediate with risk factors (1)', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
  ...
  it('Should have SV sentences in Results component type intermediate with risk factors (2)', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have SV sentences in Results component type intermediate with high LDL', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have SV sentences in Results component type intermediate with no risks', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have SV sentences in Results component type high', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have SV sentences in Info container', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nSV').then((translations) => {
