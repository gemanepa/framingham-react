...
function Form(props) {
  ...
  function calcButtonHandler() {
    ...
    if (validateSubmittedData(data)) {
      props.datasubmittedHandler(data, translations);
    }
  }
