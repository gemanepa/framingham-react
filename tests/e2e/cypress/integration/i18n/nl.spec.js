...
context('i18n | NL', () => {
  ...
  it('Should have NL sentences in Head component', () => {
    cy.fixture('i18nNL').then((translations) => {
  ...
  it('Should have NL sentences in Header component', () => {
  ...
  it('Should have NL sentences in NavButtons component', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
  ...
  it('Should have NL sentences in CalcInput component header & subheader link', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
  ...
  it('Should have NL sentences in Form component input labels', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
  ...
  it('Should have NL sentences in Results component type low', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
  ...
  it('Should have NL sentences in Results component type intermediate with risk factors (1)', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
  ...
  it('Should have NL sentences in Results component type intermediate with risk factors (2)', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have NL sentences in Results component type intermediate with high LDL', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have NL sentences in Results component type intermediate with no risks', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have NL sentences in Results component type high', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
        cy.get(object.static.form_gender_male).click({ force: true });
        cy.get(object.static.form_age_select).click({ force: true });
  ...
  it('Should have NL sentences in Info container', () => {
    cy.fixture('selectors').then((object) => {
      cy.fixture('i18nNL').then((translations) => {
