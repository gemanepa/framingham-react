  ...
  expect(i18nEs).toEqual(
    {
      ...
      unknown: 'Desconocido',
      usefulness: 'Utilidad',
      usefulness_text_start: 'La escala de Framingham permite determinar el riesgo de sufrir cualquier evento cardiovascular en 10 años evaluando factores como la edad, el sexo, la presión arterial, la diabetes y el tabaquismo, asignando un puntaje a cada uno de ellos y estratificando al paciente en niveles bajo, medio y alto riesgo cardiovascular.',
      usefulness_text_lowrisk: 'Bajo riesgo = 10% o menos',
      usefulness_text_intermediaterisk: 'Riesgo intermedio = 10-20%',
      usefulness_text_highrisk: 'Alto riesgo = 20% o más',
