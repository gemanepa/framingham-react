...
function Index() {
  ...
  var translations = {};
  __webpack_require__("./src/translations lazy recursive ^\\.\\/.*\\.json$")("./".concat(router.query.lang, ".json")).then(function (strings) {
