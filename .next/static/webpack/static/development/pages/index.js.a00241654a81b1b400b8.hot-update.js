...
function Form(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx("form", {
    ...
    label: "Female",
    className: errors.gender ? 'error' : 'asdf',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 117
    },
