...
function risklevelIntermediate(gender, ldl, hasDiabetes , wt, agePoints, hdlPoints, smokingPoints, translations) {
  const { diabetes, low, smoking, treatment_intermediate_hasfactors, waist_circumference, so_treatment_is_recommended, treatment_intermediate_ldl, treatment_intermediate_norisks } = translations;
...
function risklevelHigh(translations) {
  const { alternative_target, decrease_in, or, patient_highly_requires_treatment, primary_target } = translations;
